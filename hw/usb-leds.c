 ...
 *       Filename:  usb-leds.c
 *
 *    Description:  a usb leds virtual device for qemu.
 *
 *        Version:  1.0
 *        Created:  2011年08月01日 10时50分48秒
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
static const USBDescStrings desc_strings = {
    ...
    [STR_PRODUCT]      = "QEMU USB Led",
    [STR_SERIALNUMBER] = "15903664758",
};
